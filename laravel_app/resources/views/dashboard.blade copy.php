        ...
        <div class="az-content-body">
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6">
              <div class="card card-dashboard-pageviews">
                <div class="card-header">
                  <span class="float-sm-right"> <a href="dashboard_stock_details.php?action=gainerper" class="btn btn-sm">More</a> </span>
                  <h6 class="card-title">Top Gainer(%) </h6>
                  <p class="card-text">Overall top gainer Percentage(%).</p>
                </div><!-- card-header -->
                <div class="card-body">
                <?php
                  // $watchList = $objClass->getwatchlistSymbol();

                  // // print_r($watchList);
                  // $topgainerPer = $objClass->topGainerPer();
                  // foreach($topgainerPer as $gainerPer){
                  //   $div_off_on = "off";
                  //   if(in_array($gainerPer['info_symbol'], $watchList)){
                  //     $div_off_on = "on";
                  //   }
                  //   echo '<div class="az-list-item">
                  //       <div>
                  //       <h6>'.$gainerPer['info_name'].' <span style="color:green">'.$gainerPer['priceinfo_lastprice'].'</span></h6>
                  //       <span>'.$gainerPer['info_symbol'].'<div class="az-toggle az-toggle-secondary '.$div_off_on.'"  data-symbol="'.$gainerPer['info_symbol'].'" ><span></span></div></span>
                  //       </div>
                  //       <div>
                  //       <h6 class="tx-primary">'.$gainerPer['priceinfo_pchange'].' %</h6>
                  //       <span>'.$gainerPer['priceinfo_change'].'</span>
                  //       </div>
                  //   </div>';
                  // }
                ?>
            ...
            <div class="col-lg-6">
              <div class="card card-dashboard-pageviews">
                <div class="card-header">
                <span class="float-sm-right"> <a href="dashboard_stock_details.php?action=gainer" class="btn btn-sm">More</a> </span>
                  <h6 class="card-title">Top Gainer(Rs.) </h6>
                  <p class="card-text">Overall top gainer Amount(Rs)</p>
                </div><!-- card-header -->
                <div class="card-body">
                <?php
                  // $topgainer = $objClass->topGainer();
                  // foreach($topgainer as $gainer){
                  //   $div_off_on = "off";
                  //   if(in_array($gainer['info_symbol'], $watchList)){
                  //     $div_off_on = "on";
                  //   }
                  //   echo '<div class="az-list-item">
                  //       <div>
                  //       <h6>'.$gainer['info_name'].' <span style="color:green">'.$gainer['priceinfo_lastprice'].'</span></h6>
                  //       <span>'.$gainer['info_symbol'].'<div class="az-toggle az-toggle-secondary '.$div_off_on.'" data-symbol="'.$gainer['info_symbol'].'"><span></span></div></span>
                  //       </div>
                  //       <div>
                  //       <h6 class="tx-primary">'.$gainer['priceinfo_change'].'</h6>
                  //       <span>'.$gainer['priceinfo_pchange'].' %</span>
                  //       </div>
                  //   </div>';
                  // }
                ?>
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6">
              <div class="card card-dashboard-pageviews">
                <div class="card-header">
                <span class="float-sm-right"> <a href="dashboard_stock_details.php?action=loserper" class="btn btn-sm">More</a> </span>
                  <h6 class="card-title">Top Loser(%) </h6>
                  <p class="card-text">Overall top Loser Percentage(%).</p>
                </div><!-- card-header -->
                <div class="card-body">
                <?php
                  // $topLoserPer = $objClass->topLoserPer();
                  // foreach($topLoserPer as $loserPer){
                  //   $div_off_on = "off";
                  //   if(in_array($loserPer['info_symbol'], $watchList)){
                  //     $div_off_on = "on";
                  //   }
                  //   echo '<div class="az-list-item">
                  //       <div>
                  //       <h6>'.$loserPer['info_name'].' <span style="color:red">'.$loserPer['priceinfo_lastprice'].'</span></h6>
                  //       <span>'.$loserPer['info_symbol'].'</span><div class="az-toggle az-toggle-secondary '.$div_off_on.'"  data-symbol="'.$loserPer['info_symbol'].'" ><span></span></div>
                  //       </div>
                  //       <div>
                  //       <h6 class="tx-danger">'.$loserPer['priceinfo_pchange'].' %</h6>
                  //       <span>'.$loserPer['priceinfo_change'].'</span>
                  //       </div>
                  //   </div>';
                  // }
                ?>
            ...
            <div class="col-lg-6">
              <div class="card card-dashboard-pageviews">
                <div class="card-header">
                <span class="float-sm-right"> <a href="dashboard_stock_details.php?action=loser" class="btn btn-sm">More</a> </span>
                  <h6 class="card-title">Top Loser(Rs.) </h6>
                  <p class="card-text">Overall top Loser Amount(Rs)</p>
                </div><!-- card-header -->
                <div class="card-body">
                <?php
                  // $topLoser = $objClass->topLoser();
                  // foreach($topLoser as $loser){
                  //   $div_off_on = "off";
                  //   if(in_array($loser['info_symbol'], $watchList)){
                  //     $div_off_on = "on";
                  //   }
                  //   echo '<div class="az-list-item">
                  //       <div>
                  //       <h6>'.$loser['info_name'].' <span style="color:red">'.$loser['priceinfo_lastprice'].'</span></h6>
                  //       <span>'.$loser['info_symbol'].'</span><div class="az-toggle az-toggle-secondary '.$div_off_on.'"  data-symbol="'.$gainerPer['info_symbol'].'" ><span></span></div>
                  //       </div>
                  //       <div>
                  //       <h6 class="tx-danger">'.$loser['priceinfo_change'].'</h6>
                  //       <span>'.$loser['priceinfo_pchange'].' %</span>
                  //       </div>
                  //   </div>';
                  // }
                ?>
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6">
              <div class="card card-dashboard-pageviews">
                <div class="card-header">
                <span class="float-sm-right"> <a href="dashboard_stock_details.php?action=highprice" class="btn btn-sm">More</a> </span>
            ...
            <div class="col-lg-6">
              <div class="card card-dashboard-pageviews">
                <div class="card-header">
                <span class="float-sm-right"> <a href="dashboard_stock_details.php?action=lowprice" class="btn btn-sm">More</a> </span>
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6">
              <div class="card card-dashboard-pageviews">
                <div class="card-header">
                <span class="float-sm-right"> <a href="dashboard_stock_details.php?action=52weekhigh" class="btn btn-sm">More</a> </span>
            ...
            <div class="col-lg-6">
              <div class="card card-dashboard-pageviews">
                <div class="card-header">
                <span class="float-sm-right"> <a href="dashboard_stock_details.php?action=52weeklow" class="btn btn-sm">More</a> </span>
